...
const SHOWCASE = [
  { id: 'FSNAKE_01', name: 'Ember',     tier: 'legendary', glow: '#FF6B35' },
  { id: 'FSNAKE_07', name: 'Voidling',  tier: 'mythic',    glow: '#A455FF' },
  { id: 'FSNAKE_12', name: 'Frostbite', tier: 'epic',      glow: '#00E5FF' },
  { id: 'CSNAKE_USA', name: 'Liberty',  tier: 'exclusive', glow: '#3B82F6' },
  { id: 'CSNAKE_TR', name: 'Crescent',  tier: 'exclusive', glow: '#FF3B8A' },
  { id: 'FSNAKE_22', name: 'Solaris',   tier: 'legendary', glow: '#FFD980' },
];
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <span className={`text-[10px] uppercase tracking-wider font-bold px-2 py-1 rounded-md border tier-${s.tier}`}>
                    {t(`tiers.${s.tier}`)}
                  </span>
                </div>
              </div>
