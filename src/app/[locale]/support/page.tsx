...
import { User, CreditCard, Gamepad2, Wrench, Mail } from 'lucide-react';
...
export default async function SupportPage({ params: { locale } }: { params: { locale: string } }) {
  ...
  const faqs = [
    ...
    { q: 'Can I host private games with friends?', a: 'Friend lobbies are coming in the v3.0 update (Q3 2026). Stay tuned on our social channels for updates.' },
  ];
